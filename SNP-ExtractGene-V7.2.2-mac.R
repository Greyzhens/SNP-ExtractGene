...
#####
# 提示用户输入文件的完整路径
file_path <- "/Volumes/Grayzhens/学术资料/宁东臻/毕业论文/GWAS/MLM/NG_Env4_MLM8.txt"

# 读取用户输入的文件路径中的数据
print("正在读取TASSEL结果文件：")
print(file_path)
...
hapmap_path = "/Volumes/Grayzhens/1781835-SNP/all.snp.1781835.W272.hmp.txt"
print("正在读取hapmap文件：")
print(hapmap_path)
