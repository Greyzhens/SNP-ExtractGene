...
#####
#文件路径
WD = ("/Users/ningdongzhen/Desktop/Q16PCA")  ##此处需要更改
#GWAS结果文件
data = fread("/Users/ningdongzhen/Desktop/pca5.txt",#此处为结果文件，需使用绝对路径 ##此处需要更改
             header = F)

#gff文件
gff_gnm = c("/Volumes/Cornucopia/PeanutBase/GFF3/gnm1.ann1.CCJH/gnm1.ann1.CCJH.gene_models_main.gff3",
            "/Volumes/Cornucopia/PeanutBase/GFF3/gnm2.ann1.4K0L/gnm2.ann1.4K0L.gene_models_main.gff3")

hapmap = fread("/Volumes/Cornucopia/关联分析群体/1781835/all.snp.1781835.W272.hmp.txt" , header = T)
