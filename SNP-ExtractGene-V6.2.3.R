...
#####
#文件路径
WD = ("/Users/ningdongzhen/Desktop/1+2/")  ##此处需要更改
#GWAS结果文件
data = fread("/Users/ningdongzhen/Desktop/1+2/Calcium-1_25.txt",#此处为结果文件，需使用绝对路径 ##此处需要更改
             header = F)
data2 = data[which(data$V7!=0)]
data=data2

#gff文件
gff_gnm = c("/Users/ningdongzhen/Desktop/GFF3/gnm1.ann1.CCJH/gnm1.ann1.CCJH.gene_models_main.gff3",
            "/Users/ningdongzhen/Desktop/GFF3/gnm2.ann1.4K0L/gnm2.ann1.4K0L.gene_models_main.gff3")

hapmap = fread("/Users/ningdongzhen/Desktop/all.snp.1781835.W272.hmp.txt" , header = T)
